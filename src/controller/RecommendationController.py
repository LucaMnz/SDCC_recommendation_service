from src.nearestNeighbors.CollaborativeFilteringCore import elaborate_features
from src.nearestNeighbors.StreamingLearning import Streaming_learning
import numpy as np
import pandas as pd
...
class RecommendationController:
    ...
    def __init__(self, n_neighbors):
        ...
        self.restaurant_features = elaborate_features()
